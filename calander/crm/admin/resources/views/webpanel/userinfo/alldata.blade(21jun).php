                       ...
                       //echo '<pre>';print_r($allProductDetail['due_date'][$t]); 
                        ...
                        @endif
                            ...
                            <td> 
                             ...
                             <td>@if($allProductDetail['pprice'][$k]['pprice'] > 0 && ($allProductDetail['total1'][$k]-$allProductDetail['pprice'][$k]['pprice']) > 0)
                                <button type="button" class="btn btn-success sendMail" data="{{$k+1}}" data-toggle="modal" data-target="#myModal2" data1="{{$allusers['id']}}" data2="{{$allusers['IID']}}">Send Mail</button>
                                @endif
                             </td>
                        </tr>
                        @endif
  ...
  <div class="modal" id="myModal2">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h1 class="modal-title">Send E-mail</h1>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <div class="modal-body">
          <div class="container">
              <form action="{{ sysUrl('send-email') }}/{{Request::segment(3)}}" method="post">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success kk" >Send E-mail</button>
                </div>
              </form>
          </div>
        </div>
