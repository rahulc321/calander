                    ...
                    <tbody>
                     ...
                     $grandTotal= $userInfo['paid'][$alluser['id']]+$userInfo['unpaid'][$k]+$userInfo['cancel'][$k];
                        ...
                        <tr>
                            ...
                            <!--  -->
                              <label class="label label-success"> {{currency(abs($userInfo['paid'][$alluser['id']]+$userInfo['laser_price1'][$alluser['id']]))}}</label> 
                            @else
                            <label class="label label-success"> {{currency(@$userInfo['paid'][$alluser['id']])}}</label>
                            ...
                            <label class="label label-warning">{{currency(abs(@$userInfo['unpaid'][$k]-$userInfo['laser_price1'][$alluser['id']]))}}</label>
                            @endif
                            @else
                                @if(!empty($userInfo['unpaid'][$k]))
                                <label class="label label-warning"> {{currency(@$userInfo['unpaid'][$k])}}</label>
                                @endif
                            @endif
                            ...
                            <td>
                                ...
                                <label class="label label-danger">{{currency(@$userInfo['cancel'][$k])}}</label>
                                @endif
                            </td>
