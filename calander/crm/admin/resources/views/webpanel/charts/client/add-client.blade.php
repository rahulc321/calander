                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal " method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="subject" name="first_name" required="" value="{{$client->first_name}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="subject" name="email" required="" value="{{$client->email}}">
                                </div>
                            </div>
