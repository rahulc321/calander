            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select class="lazySelector select2" name="product_id" style="width:100%;"
                                    data-selected="{{ Input::get('product_id') }}">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select class="form-control lazySelector" name="status"
                            ...
                            <option value="">All</option>
                            @foreach(\App\Modules\FactoryOrders\FactoryOrder::GetStatusAsArray() as $k => $status)
                ...
                <div class="col-md-2">
                    <div style="padding-top: 25px;">
                        ...
                        <a class="btn btn-danger btn-sm margin-top-10" href="{{ sysRoute('factoryorders.index')}}">Reset</a>
                    </div>
                </div>
            </div>
        </form>
