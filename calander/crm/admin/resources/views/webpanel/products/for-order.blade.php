...
<link rel="stylesheet" href="{{Request::root()}}/selectbox/css/style.css">
  <link rel="stylesheet" href="{{Request::root()}}/selectbox/css/customoptions.css"> 
  <link rel="stylesheet" id="theme" href="{{Request::root()}}/selectbox/css/selectric.css">
                                ...
                                <div class="col-md-7">
                                    ...
                                    @if($variants->count() > 0)
                                        @foreach($variants as $variant)
                                            ...
                                            <!-- <option value="{{ $variant->id }}" data-id="{{ $variant->id }}" data-stock-label="{{ $variant->qty > 0 ? 'In Stock' : 'Out Of Stock' }}"
                                               data-id="{{ $variant->id }}" <?php if($colorName=='Black' || $colorName=='Brown' || $colorName=='Blue Marine' || $colorName=='Bordeaux'){ $txtColor= 'white';}else{ $txtColor='black'; } ?> style="background:{{ @$variant->color->hex_code }};color:{{$txtColor}}">
                                               {{ @$variant->color->name }}
                                            </option> -->


                                            <option data-id="{{ $variant->id }}" data-id="{{ $variant->id }}" data-name="{{ @$variant->color->name }}" data-stock-label="{{ $variant->qty > 0 ? 'In Stock' : 'Out Of Stock' }}" value="{{ @$variant->color->hex_code }}">{{ @$variant->color->name }}</option>
...
@section('scripts')
<!-- <script src="{{Request::root()}}/selectbox/js/jquery.selectric.js"></script>
  <script src="{{Request::root()}}/selectbox/js/demo.js"></script>-->
    <script>
