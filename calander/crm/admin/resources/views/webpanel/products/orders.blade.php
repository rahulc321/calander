    ...
    <div class="row">
        @if(auth()->user()->isAdmin())
            <div>
                ...
                <b class="pprice">Selling Price : <span class="price1">{{currency($sum)}}</span></b>

                <b class="sel-price">Total Product Price : <span class="price1">{{currency($salePrice)}}</span></b>
            </div>
            <br>
        @endif
        <div class="col-lg-12">
                        ...
                        <tr>
                            <td colspan="6"><strong>{{ $product->name }}</strong>
                                @if(auth()->user()->isAdmin())
                                    ...
                                    Selling Price: {{$product->buying_price}} 
                                    <br>
                                @endif
