                    ...
                    <div class="panel-body">
                        <form class="ajaxForm form-horizontal" method="post" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control" id="webshop_price" name="webshop_price" value="<?php echo e(Input::get('webshop_price')); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control" id="seo_title" name="seo_title" value="<?php echo e(Input::get('seo_title')); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" for="seo_description">SEO | Description:</label>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" id="seo_description" name="seo_description" value="<?php echo e(Input::get('seo_description')); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" for="seo_keywords">SEO | Keywords:</label>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" id="seo_keywords" name="seo_keywords" value="<?php echo e(Input::get('seo_keywords')); ?>">
                                </div>
                            </div>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $(document).ready(function(){
            ...
            var url= ""<?php echo e(URL::route('webpanel.products.store')); ?>";
            alert(url);
            ...
            $.ajax({
              type:'post',
              url:"<?php echo e(URL::route('webpanel.products.store')); ?>",
