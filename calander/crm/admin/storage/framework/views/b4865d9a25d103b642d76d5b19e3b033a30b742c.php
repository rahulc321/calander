                        ...
                        <form method="get" class="form-horizontal">
                            <div class="form-group">
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control dp" id="date_from" name="date_from" value="<?php echo e(Input::get('date_from')); ?>">
                                </div>
                                <div class="col-md-2">
                                    <label for="date_to">Date To:</label>
                                    <input type="text" class="form-control dp" id="date_to" name="date_to" value="<?php echo e(Input::get('date_to')); ?>">
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2" style="padding-left: 30px;">
                                    ...
                                    <label>&nbsp;</label>
                                    <input type="submit" name="search" value="Filter" class="btn btn-primary btn-sm">
                            ...
                            <table class="table">
                                ...
                                <?php foreach($variants as $k => $variant): ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo e(@$variant->product ? $variant->product->getThumbUrl() : dummyUrl()); ?>"></td>
