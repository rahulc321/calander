          ...
          <li>
                    ...
                    <ul>
                        <li class="<?php echo \Optimait\Laravel\Helpers\Nav::isActiveMultiple(array('view-map')) ? 'active' : ''; ?>">
                            <a href="<?php echo e(sysUrl('view-map')); ?>"><span>View Map</span>
                            <i class="fa fa-map-marker"></i>
                            </a>
                        </li>
                        <li class="<?php echo \Optimait\Laravel\Helpers\Nav::isActiveMultiple(array('future-client')) ? 'active' : ''; ?>">
                            <a href="<?php echo e(sysUrl('future-client')); ?>"><span>Future Client</span>
             ...
             <?php endif; ?>
               ...
               <?php if(auth()->user()->isAdmin()): ?>
                <li>
                    <a href="<?php echo e(sysUrl('website_info')); ?>"><span>Update Website Info</span>
                        <i class="icon-info"></i>
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(sysUrl('enquiry')); ?>"><span>All Enquiry</span>
                        <i class="icon-info"></i>
                    </a>
                </li>
                 <li>
                    <a href="<?php echo e(sysUrl('coupons')); ?>"><span>All Coupons</span>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li class="<?php echo \Optimait\Laravel\Helpers\Nav::isActiveMultiple(array('list-newsletter')) ? 'active' : ''; ?>">
                            <a href="<?php echo e(sysUrl('list-newsletter')); ?>">List Newsletter Users</a>
                        </li>
                        <li class="<?php echo \Optimait\Laravel\Helpers\Nav::isActiveMultiple(array('sent-email')) ? 'active' : ''; ?>">
                            <a href="<?php echo e(sysUrl('sent-email')); ?>">List Sent Email</a>
                        </li>
