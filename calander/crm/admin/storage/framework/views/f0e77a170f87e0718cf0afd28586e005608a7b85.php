                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal " method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="subject" name="first_name"  value="<?php echo e($client->first_name); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="subject" name="email" value="<?php echo e($client->email); ?>">
                                </div>
                            </div>
                            <!-- 23 Aug -->
                        <div class="form-group">
