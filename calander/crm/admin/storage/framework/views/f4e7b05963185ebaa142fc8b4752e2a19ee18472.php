                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal " method="post"
                              action="<?php echo e($url); ?>/<?php echo e($edit->id); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="txtName" name="coupon_code" readonly="" required="" value="<?php echo e($edit->coupon_code); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="from" name="from"  value="<?php echo e($edit->start_date); ?>" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="to" name="to" value="<?php echo e($edit->end_date); ?>" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="uses" name="uses" value="<?php echo e($edit->uses); ?>" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select name="ctype" class="form-control ctype">
                                      ...
                                      <option value="fixed" <?php if($edit->cupon_type=="fixed"): ?> <?php echo e('selected'); ?><?php endif; ?>>Fixed Amount</option>
                                      <option value="percent" <?php if($edit->cupon_type=="percent"): ?> <?php echo e('selected'); ?><?php endif; ?>>Percent</option>
                                    </select>
                            ...
                            <div class="form-group fix" style="display:none">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control fixamt" id="fixamt" name="famount" value="<?php echo e($edit->price); ?>"  >
                             ...
                             <div class="form-group percent" style="display:none">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control fixamt" id="percent" name="percent" value="<?php echo e($edit->price); ?>"  >
                        ...
                        <br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6"  >
                                    ...
                                    &nbsp;
                                    &nbsp;
                                    <a href="<?php echo e(url('/webpanel/coupons')); ?>"  class="btn btn-danger submit-btn" style="float:left;margin-left: 10px" >Back</a>
                                </div>
...
<script type="text/javascript">
  ...
  if (input < 1 || input > 100){
    ...
    $(document).ready(function () {
      ...
      var ctype="<?php echo e($edit->cupon_type); ?>";
      if(ctype=='fixed'){
        $('.fix').show();
        $('.percent').hide();
      }else if(ctype=='percent'){
