    ...
    <div class="row">
        <?php if(auth()->user()->isAdmin()): ?>
            <div>
                ...
                <b class="pprice">Selling Price : <span class="price1"><?php echo e(currency($sum)); ?></span></b>

                <b class="sel-price">Total Product Price : <span class="price1"><?php echo e(currency($salePrice)); ?></span></b>
            </div>
            <br>
        <?php endif; ?>
        <div class="col-lg-12">
                        ...
                        <tr>
                            <td colspan="6"><strong><?php echo e($product->name); ?></strong>
                                <?php if(auth()->user()->isAdmin()): ?>
                                    ...
                                    Selling Price: <?php echo e($product->buying_price); ?> 
                                    <br>
                                <?php endif; ?>
