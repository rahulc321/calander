...
class PdfExportService
{
    ...
    private $exportPath1 = './uploads/attachments/pdf/';
    ...
    public function save1(\Closure $c = null)
    {
        if (!is_null($c)) {
            $c($this);
        }
        ...
        @$this->exporter->setWarnings(false)->save($this->exportPath1 . $this->exportedFileName);
