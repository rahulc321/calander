...
/*************************************************************/
        ...
        return view('webpanel.userinfo.index')->with('userInfo',$allData)->with('unPaid',$sum);
        //Total= 1145786.50
        //Unpaid= 259208.00
        //paid= 852556.50
        // cancel= 34022.00
    ...
    function user_data($id){
        ...
        return view('webpanel.userinfo.alldata')->with('allProductDetail',$uData)->with('unpaid',$unpaid)->with('total_ramainging',$total_ramainging)->with('lprice',$dArr);
    }
