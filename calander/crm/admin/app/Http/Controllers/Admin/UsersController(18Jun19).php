...
/*************************************************************/
    ...
    function user_data($id){
        ...
        $uData = Item::join('invoices','invoices.order_id','=','order_items.order_id')->where('order_items.created_by',$id)->where('invoices.status',2)->groupBy('order_items.order_id')->orderBy('invoices.id', 'DESC')->get();
