...
class Xero extends AbstractService
{
    ...
    {
        return new Uri('https://api.xero.com/oauth/RequestToken');
    }
    ...
    {
        return new Uri('https://api.xero.com/oauth/Authorize');
    }
    ...
    {
        return new Uri('https://api.xero.com/oauth/AccessToken');
    }
