...
class ProductsController extends Controller
{
    ...
    public function getItemForOrder($id)
    {
        ...
        @$userReview = Review::where('productId', $id)->where('userId',\Auth::user()->id)->get();
        }
        //echo '<pre>';print_r($review);die;

        return view('webpanel.front.single')->with('product',$product)->with('reviews',$reviews)->with('userReview',@$userReview)->with('multi_photo',$multi_photo);
    }
