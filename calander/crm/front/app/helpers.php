...
function postFooter(){
        ...
        $productFooter = App\Modules\Products\Product::where('id','!=',0)->where('web_shop_price','!=',0)->where('deleted_at',null)->orderBy('name','asc')->paginate(6);
    ...
    function email(){
        $email1 =  DB::table('website_info')->where('id',1)->first();
        return $email1->info;
    }
    function phone(){
        $phone =  DB::table('website_info')->where('id',2)->first();
        return $phone->info;
    }
    function facebook(){
        $facebook=  DB::table('website_info')->where('id',3)->first();
        return $facebook->info;
    }
    function twiter(){
        $twiter=  DB::table('website_info')->where('id',4)->first();
        return $twiter->info;
    }
    function google(){
        $google=  DB::table('website_info')->where('id',5)->first();
        return $google->info;
    }
    function insta(){
        $instta=  DB::table('website_info')->where('id',6)->first();
        return $instta->info;
    }
    function address(){
        $address=  DB::table('website_info')->where('id',7)->first();
        return $address->info;
    }
