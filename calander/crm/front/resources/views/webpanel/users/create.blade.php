        ...
        <div class="panel-body">
            <form class="form-horizontal ajaxForm" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <textarea name="address" class="form-control" style="min-height: 80px;">{{ Input::old('address') }}</textarea>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <select class="form-control" name="country" data-selected="{{ Input::old('country') }}">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="zipcode" value="{{ Input::old('zipcode') }}">
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <select class="form-control lazySelector" id="user_type_id" name="user_type_id"
                                ...
                                <option value="{{ \App\Modules\Users\Types\UserType::SALES_PERSON }}">Sales Person
                                </option>
                ...
                @else
                    <input type="hidden" name="user_type_id" value="{{ \App\Modules\Users\Types\UserType::CUSTOMER }}">
                @endif

                <?php $debitorNumber = \App\User::getNewDebitorValue(); ?>
                <div class="hideable hidden" id="type-{{ \App\Modules\Users\Types\UserType::CUSTOMER }}">
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" class="form-control" id="password" name="password" value="{{ Input::get('password') }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" class="form-control" id="password_confirmation" name="password_confirmation" value="{{ Input::get('password_confirmation') }}">
                    </div>
                </div>
