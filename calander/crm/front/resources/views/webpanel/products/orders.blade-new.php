                    ...
                    @foreach($products as $product)
                        ...
                        <tr>
                            <td colspan="6"><strong>{{ $product->name }}</strong>
                                @if(auth()->user()->isAdmin())
                                    <br>Buying Price:{{ currency($product->buying_price) }}<br>
                                @endif
                            ...
                            <tr>
                                ...
                                @if(auth()->user()->isAdmin())
                                    ...
                                    <!-- <td>
                                        ...
                                        @if($variant->getTotalOrdered() !=0)<span
                                                class="label label-success">
                                       ({{$variant->qty}} - {{$variant->getTotalOrdered()}})
                        ...
                        <tr>
                            ...
                            @if(auth()->user()->isAdmin())
                                <br><strong>Stock Amount: {{ currency($totalStock * $product->buying_price) }}</strong><br>
                            @endif
                            </td>
