...
<body>
<!-- <center><img src="https://shop.morettimilano.com/public/front/images/moretti-leather-bags-logo.png" height="90"></center> -->
              ...
              <table class="col-600" width="600" align="center" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td>
                    ...
                    <table class="col1" width="183" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td align="center">
                          <center><img style="" class="images_style" src="https://shop.morettimilano.com/public/front/images/moretti-leather-bags-logo.png" alt="img" width="156" height="50" style="text-align: center !important"></center>
                        </td>
                ...
                <tbody><tr>
                  <td align="center">
                    <table class="insider" width="237" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tbody><tr align="left">
                        <td style="font-family: 'Raleway', sans-serif; font-size:23px; color:#333; line-height:30px; font-weight: bold;">Hi there</td>
                      </tr>
                      ...
                      <tr>
                        <td style="font-family: 'Lato', sans-serif; font-size:14px; color:#7f8c8d; line-height:24px; font-weight: 300;">
                          <b><i style="color:green">Thankyou for your subcsription!!</i></b><br><br><br>
                          <a target="_blank" href="{{url('/')}}/unsubscribe/{{base64_encode($data1['email'])}}" style="text-decoration: none;background-color: red;
    padding: 10px;
    color: wheat;
    border-radius: 10px;
    font-size: 18px;"><b>Unsubscribe</b></a>
                        </td>
          ...
          <tr>
            ...
            <td align="center" bgcolor="#333">
              <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="font-family: 'Raleway', sans-serif; font-size:20px; color:#fbb016; line-height:24px; font-weight: bold;">Moretti Milano</td>
                </tr>
                ...
                <tr>
                  <td align="center" style="font-family: 'Lato', sans-serif; font-size:14px; color:#fff; line-height: 1px; font-weight: 300;">
                    Main Office, Moretti Milano, Piazza IV Novembre 4 , 20124 Milano MI, Italy
                  </td>
                </tr>
