...
<title><?php echo e(trim(View::yieldContent('title1'))); ?></title>

<link rel="canonical" href="<?php echo e(Request::fullUrl()); ?>" />
<link rel="apple-touch-icon" sizes="57x57" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/apple-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/apple-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/apple-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/apple-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/apple-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/apple-icon-120x120.png">
<link rel="apple-touch-icon" sizes="144x144" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/apple-icon-144x144.png">
<link rel="apple-touch-icon" sizes="152x152" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/apple-icon-152x152.png">
<link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/apple-icon-180x180.png">
<link rel="icon" type="image/png" sizes="192x192"  href="<?php echo e(Request::root()); ?>/public/assets/images/fav/android-icon-192x192.png">
<link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="96x96" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/favicon-96x96.png">
<link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/favicon-16x16.png">
<link rel="manifest" href="<?php echo e(Request::root()); ?>/public/assets/images/fav/manifest.json">
<meta name="msapplication-TileColor" content="#ffffff">
<meta name="msapplication-TileImage" content="<?php echo e(Request::root()); ?>/public/assets/images/fav/ms-icon-144x144.png">
<meta name="theme-color" content="#ffffff">


<!-- for-mobile-apps -->
<meta name="description" content="<?php echo e(trim(View::yieldContent('description1'))); ?>">

<meta name="keywords" content="<?php echo e(trim(View::yieldContent('keywords'))); ?>" />
<meta name="title" content="<?php echo e(trim(View::yieldContent('title1'))); ?>)" />
...
<link href="<?php echo e(Request::root()); ?>/public/front/css/custom.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?php echo e(Request::root()); ?>/public/front/css/msdropdown_dd.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script src="<?php echo e(Request::root()); ?>/public/front/js/jquery.min.js"></script>
<script id="lazy" src="<?php echo e(Request::root()); ?>/public/front/js/jquery.lazy.min.js"></script>
<script>
...
<!-- header -->
   ...
   <!--         <select class="language">-->
			...
			<select id="lang" class="language"  style="width:200px">
				<option value="en" data="<?php echo e(url('/')); ?>/en/<?php echo e($actUrl[4]); ?>" data-image="<?php echo e(Request::root()); ?>/public/front/images/flags/english.png">English</option>
				<option value="ru" data="<?php echo e(url('/')); ?>/ru/<?php echo e($actUrl[4]); ?>" data-image="<?php echo e(Request::root()); ?>/public/front/images/flags/russia.png">Russian</option>
				<option value="it" data="<?php echo e(url('/')); ?>/it/<?php echo e($actUrl[4]); ?>" data-image="<?php echo e(Request::root()); ?>/public/front/images/flags/italy.png">Italian</option>
				<option value="de" data="<?php echo e(url('/')); ?>/de/<?php echo e($actUrl[4]); ?>" data-image="<?php echo e(Request::root()); ?>/public/front/images/flags/germany.png">German</option>
				<option value="gr" data="<?php echo e(url('/')); ?>/gr/<?php echo e($actUrl[4]); ?>" data-image="<?php echo e(Request::root()); ?>/public/front/images/flags/greece.png">Greece</option>
				<option value="dk" data="<?php echo e(url('/')); ?>/dk/<?php echo e($actUrl[4]); ?>" data-image="<?php echo e(Request::root()); ?>/public/front/images/flags/denmark.png">Denmark</option>
				<option value="se" data="<?php echo e(url('/')); ?>/se/<?php echo e($actUrl[4]); ?>" data-image="<?php echo e(Request::root()); ?>/public/front/images/flags/sweden.png">Sweden</option>
				<option value="no" data="<?php echo e(url('/')); ?>/no/<?php echo e($actUrl[4]); ?>" data-image="<?php echo e(Request::root()); ?>/public/front/images/flags/norway.png">Norway</option>
				<option value="fi" data="<?php echo e(url('/')); ?>/fi/<?php echo e($actUrl[4]); ?>" data-image="<?php echo e(Request::root()); ?>/public/front/images/flags/finland.png">Finland</option>
				<option value="jp" data="<?php echo e(url('/')); ?>/jp/<?php echo e($actUrl[4]); ?>" data-image="<?php echo e(Request::root()); ?>/public/front/images/flags/japan.png">Japan</option>
			</select>
			</div>
			</div>
            ...
            <script>
               /* function googleTranslateElementInit() {
        		...
        		window.location.href = actUrl;
                 ...
                 var url= "<?php echo e($actUrl[3]); ?>";
            //	alert(url);
            	$(".cl").each(function(){
            		var value= $(this).attr("href");
            		var arr=value.split('/');
            		var actUrl= "<?php echo e(url('/')); ?>";
            		//alert(arr[3]);
            		if(url !=""){
            			if(arr[3] != undefined){
			...
			<div class="header-grid cstm_frntlay_hdgrd">
				<div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<ul>
						...
						<!--<li><i class="glyphicon glyphicon-user cstm_frntlay_glfuser" aria-hidden="true"></i>Welcome : <?php echo e(Auth::user()->full_name); ?><span ><b ></b></span></li>-->
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					...
					<a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(Request::root()); ?>/public/front/images/moretti-leather-bags-logo.png" alt="Moretti leather bags logo"></a>
				...
				<div class="logo-nav-left1">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav menu">
							<li class="active hacti"><a href="<?php echo e(url('/')); ?>" class="act hact cl">Home</a></li>	
							<!-- Mega Menu -->
							<li class="dropdown">
								<a href="<?php echo e(url('/products')); ?>" class="dropdown-toggle cl"  >Products</b></a>
								 
							</li>
							<li class="dropdown">
								<a href="<?php echo e(url('/blog')); ?>" class="dropdown-toggle cl"  >Blog</b></a>
								 
							</li>
							 
							 
							<li><a href="<?php echo e(url('/contact')); ?>" class="cl">Contact Us</a></li>
							<?php if(!empty(Auth::user())): ?>
						<!--<li class="cstm_frntlay_wel"><a href="javascript:;">Welcome : <?php echo e(Auth::user()->full_name); ?></a></li>-->
							

							<li><a href="<?php echo e(url('/order-history')); ?>" class="cl">My Account</a></li>
						
							<li><a href="<?php echo e(url('/logout')); ?>">Logout</a></li>
						<?php else: ?>
						<li><a href="<?php echo e(url('/user-login')); ?>" class="cl">Login</a></li>
						<li><a href="<?php echo e(url('/user-register')); ?>" class="cl">Register</a></li>
						<?php endif; ?>
						</ul>
					</div>
					</nav>
				...
				<div class="logo-nav-right">
					<div class="search-box">
						...
						<script id="uisearch" src="<?php echo e(Request::root()); ?>/public/front/js/uisearch.js" async></script>
							<script>
					...
					<div class="cart box_1">
						<a href="<?php echo e(url('/orders/cart/xl')); ?>">
							<h3> 
								...
								<?php endif; ?>
								<img src="<?php echo e(Request::root()); ?>/public/front/images/bag.png" alt="Bag" />
							</h3>
						</a>
...
Our young and vibrant design team finds inspiration in today’s emerging trends from Milan, to bring you some of the best Italy has to offer</p>
				...
				<div class="col-md-4 footer-grid animated wow slideInLeft" data-wow-delay=".7s">
					...
					<div class="footer-grid-left">
						<a href="<?php echo e(url('/single/')); ?>/<?php echo e(encryptIt($fProduct->id)); ?>"><img src="<?php echo e(IMGPATH); ?>/public/<?php echo e($folder.$fileName); ?>" alt="<?php echo e($fProduct->name); ?>" onerror="this.onerror=null;this.src='<?=NO_IMG?>'" class="img-responsive" title="<?php echo e($product->name); ?>" /></a>
					</div>
				 
					<?php endforeach; ?>
			
					<div class="clearfix"> </div>
					<a href="<?php echo e(url('/shipping-policy')); ?>" target="_blank">Shipping Policy</a></a>
				</div>
			...
			<div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
				...
				<a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(Request::root()); ?>/public/front/images/moretti-leather-bags-logo-new.png" alt="Moretti leather bags logo"></a>
			</div>
...
<script src="<?php echo e(Request::root()); ?>/public/front/js/msdropdown_jquery.dd.js"></script>
...
//  for news leter
        $('.newsbtn').click(function(event){
           ...
           //alert(newemail);
            ...
            var checked= 1;
            $.ajax({
            url:"<?php echo e(url('/news-letter')); ?>",
            method:'post',
            data:{'_token':"<?php echo e(csrf_token()); ?>",'email':newemail,'checkbox':checked},
