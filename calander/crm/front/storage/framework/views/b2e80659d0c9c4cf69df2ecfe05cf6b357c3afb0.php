...
<!-- checkout -->
 	...
 	<div class="checkout">
		<div class="container">
			<p class="alert alert-info cstm_checkout_success">You have Successfully Updated Cart <img src="<?php echo e(Request::root()); ?>/public/front/images/bag.png" alt="Bag" /></p>
			...
			<span class="cstm_checkout_sp"> 
                <small class="cstm_checkout_oid">ORDER ID: <?php echo e($order->OID); ?></small>
            </span>
            ...
            <div class="callout callout-danger cstm_checkout_dng">
                <h5><i class="icon-cart-add"></i><img src="<?php echo e(Request::root()); ?>/public/front/images/bag.png" alt="Bag" /> No Items in a cart</h5>
			...
			<div class="checkout-right animated wow slideInUp" data-wow-delay=".5s">
				<table class="timetable_sub">
					...
					<tr class="rem1">
						...
						<td class="invert-image"><img src="<?php echo e(IMGPATH); ?>/public/<?php echo e($folder.$fileName); ?>" alt="<?php echo e(@$item->product->name); ?>" class="img-responsive cstm_checkout_tdimg" onerror='this.onerror=null;this.src="<?php echo NO_IMG; ?>"'/></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">    <div class="centr">                       
									<input type="number" class="form-control inc kk cstm_checkout_inp" name="qty" value="<?php echo e($item->qty); ?>" min="1" max="<?php echo e($variantData['qty']); ?>" data-qty="<?php echo e($variantData['qty']); ?>" data="<?=$i?>" data-productid='<?php echo e($item->id); ?>'>
								</div>
								</div>
							</div>
						</td>
						...
						<td class="invert product_price_<?=$i?>" data-price="<?php echo e($item['product']['web_shop_price']/euro()->conversion); ?>"> <?php if($item['product']['web_shop_price'] !=0): ?>
                            <?php /*currency($item['product']['web_shop_price'])*/ ?>
                             €<?php echo e(number_format($item['product']['web_shop_price']/euro()->conversion,2)); ?>
						...
						<td class="invert">
							...
							<span class="pp_<?=$i?>">
							    <!--<?=currency($totalPrice)?>-->
							     €<?php echo e(number_format($totalPrice/euro()->conversion,2)); ?>
	...
	<script>
		...
		// working on onload
		 $('.apply').click(function(){
		 	...
		 	$.ajax({
				...
				method:'post',
				data:{'_token':"<?php echo e(csrf_token()); ?>",'code':code,'orderId':"<?php echo e($order->OID); ?>"},
				success:function(result){
					if(result==0){
		...
		$("#guest_check").click(function() {
		   ...
		   if(email == ""){
			...
			$.ajax({
                url: "<?php echo e(url('/check-guest')); ?>",
                type: 'post',
                data: {'_token':"<?php echo e(csrf_token()); ?>",'guestEmail':email},
		...
		//03-01-2020
			...
			var cpntype= "<?php echo e($cpnData->cpn_type); ?>";
			//alert(cpntype);
			if(cpntype=='fixed'){
				var pricecpn="<?php echo e(number_format($cpnData->cpn_price/euro()->conversion)); ?>";
				...
				var pricecpn="<?php echo e($cpnData->cpn_price); ?>";
