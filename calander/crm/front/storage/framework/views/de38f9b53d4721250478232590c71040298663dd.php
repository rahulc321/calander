                    ...
                    <tbody>
                     ...
                     $grandTotal= $userInfo['paid'][$alluser['id']]+$userInfo['unpaid'][$k]+$userInfo['cancel'][$k];
                        ...
                        <tr>
                            ...
                            <!--  -->
                              <label class="label label-success"> <?php echo e(abs($userInfo['paid'][$alluser['id']]+$userInfo['laser_price1'][$alluser['id']])); ?></label> 
                            <?php else: ?>
                            <label class="label label-success"> <?php echo e(@$userInfo['paid'][$alluser['id']]); ?></label>
                            ...
                            <td>
                                ...
                                <label class="label label-danger"><?php echo e(@$userInfo['cancel'][$k]); ?></label>
                                <?php endif; ?>
                            </td>
