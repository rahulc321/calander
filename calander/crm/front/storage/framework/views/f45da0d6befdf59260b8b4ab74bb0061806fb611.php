					...
					<div class="flexslider">
                        ...
                        <?php foreach($product->photos as $photos): ?>
							...
							$fileName= $photos['media']['filename'] 
                             ...
                             <li data-thumb="<?php echo e(IMGPATH); ?>/public/<?php echo e($folder.$fileName); ?>">
								<div class="thumb-image"> <img src="<?php echo e(IMGPATH); ?>/public/<?php echo e($folder.$fileName); ?>" data-imagezoom="true" class="img-responsive" onerror="this.onerror=null;this.src='<?php echo e(Request::root()); ?>/public/front/images/no_image.jpg'"> </div>
							</li>
                        <?php endforeach; ?>
                        <?php endif; ?>                     
                        <?php if($multi_photo): ?>
                          <?php foreach($multi_photo as $value): ?>
                             <li data-thumb="<?php echo e(IMGPATH); ?>/public/webshop_Images/<?php echo e($value->image); ?>">
								<div class="thumb-image"> <img src="<?php echo e(IMGPATH); ?>/public/webshop_Images/<?php echo e($value->image); ?>" data-imagezoom="true" class="img-responsive" onerror="this.onerror=null;this.src='<?php echo e(Request::root()); ?>/public/front/images/no_image.jpg'"> </div>
							</li>                   
                          <?php endforeach; ?>
                        <?php endif; ?>
                                    ...
                                    <?php if($variants->count() > 0): ?>
                                        ...
                                        <?php foreach($variants as $variant): ?>
                                           ...
                                           <!--  <a class="color-box" style="background:<?php echo e(@$variant->color->hex_code); ?>"
                                               ...
                                               <option data-stock-label="<?php echo e($variant->qty > 0 ? 'In Stock' : 'Out Of Stock'); ?>"
