        ...
        <ul class="info-blocks">
             <li class="bg-primary">
                <div class="top-info">
                    ...
                    <div class="statusText"><?php echo e(currency((float) \App\Modules\Orders\Order::forToday()->paid()->sum('price'))); ?></div>
                </div>
            ...
            <li class="bg-success">
                <div class="top-info">
                    ...
                    <div class="statusText"><?php echo e((int) \App\User::customers()->onlyMine()->forToday()->count('id')); ?></div>
                </div>
            ...
            <li class="bg-info">
                <div class="top-info">
                    ...
                    <div class="statusText"><?php echo e((int) \App\Modules\Orders\Order::forToday()->ordered()->count('id')); ?></div>
                </div>
