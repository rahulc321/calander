...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <div class="new-collections">
        <div class="container">
            <h3 class="animated wow zoomIn" data-wow-delay=".5s">All Products</h3>
                ...
                <div class="col-md-3 new-collections-grid">
                    ...
                    <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
                        <div class="new-collections-grid1-image" style="height: 200px !important;">
                            <a href="<?php echo e(url('/single/')); ?>/<?php echo e(encryptIt($product->id)); ?>" class="product-image">
                                <img src="<?php echo e(IMGPATH); ?>/public/<?php echo e($folder.$fileName); ?>" alt=" " class="img-responsive"  onerror="this.onerror=null;this.src='<?php echo e(Request::root()); ?>/public/front/images/no_image.jpg'" />
                            </a>
                        ...
                        <?php endif; ?>
                    </span><a class="item_add" href="javascript:;" data-toggle="modal" data-target="#myModal" data="<?php echo e($product->name); ?>" data-id="<?php echo e(encryptIt($product->id)); ?>">add to cart </a></p>
                        </div>
                    </div>
