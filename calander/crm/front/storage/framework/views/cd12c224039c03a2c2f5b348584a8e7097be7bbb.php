                ...
                <table class="table table-bordered  table-binvoiceed deleteArena table-striped"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <span class="gamount" ><?php echo e($total_ramainging['total_amt']); ?> ==2</span>
                             <?php else: ?>
                             0.00
                             <?php endif; ?>
                            </td>
                    ...
                    <tbody>
                      ...
                      $totalProductTax= ($alluser->price+$alluser->shipping_price)*$alluser->tax_percent/100; 
                        ...
                        <tr>
                            ...
                            <td class="productPrice_<?php echo e($k+1); ?>"><?php echo e($alluser->price+$alluser->shipping_price+$totalProductTax); ?></td>
                            <td class="paidPrice_<?php echo e($k+1); ?>"><?php echo e($totalLaserPrice); ?></td>
                            <td class="unpaidPrice_<?php echo e($k+1); ?>">
                            <?php if(!empty($totalLaserPrice)): ?>

                            <?php echo e(($alluser->price+$alluser->shipping_price+$totalProductTax)-$totalLaserPrice); ?>
            ...
            $('.update').click(function(){
               ...
               //alert(totalamt);
                ...
                if(parseInt(ramount) < parseInt(amt)){
                   ...
                   if(parseFloat(totalamt) > parseFloat(productprice)){ 
