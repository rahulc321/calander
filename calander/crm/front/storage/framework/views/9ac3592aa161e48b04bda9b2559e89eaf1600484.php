<div class="modal-dialog">
    <div class="modal-content">
        <form method="post" action="<?php echo e(sysUrl('users/message-inactive/'.encryptIt($user->id))); ?>"
            ...
            <div class="modal-body with-padding">
                <ul>
                    <?php foreach($user->messages as $message): ?>
                        <li><?php echo e($message->message); ?><br>
                            <span class="text-primary">on <?php echo e($message->createdDate()); ?></span>
                        </li>
                    <?php endforeach; ?>
                </ul>
