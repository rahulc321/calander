            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select class="form-control lazySelector" name="status"
                            ...
                            <option value="">All</option>
                            <?php foreach(\App\Modules\Orders\Order::GetStatusAsArray() as $k => $status): ?>
                ...
                <div class="col-md-3">
                    <div style="padding-top: 25px;">
                        ...
                        <a class="btn btn-danger btn-sm margin-top-10" href="<?php echo e(sysRoute('orders.index')); ?>">Reset</a>
                        <a href="<?php echo e(sysUrl('orders/download-all/xl')); ?>?<?php echo e(http_build_query(Input::except('page'))); ?>"
