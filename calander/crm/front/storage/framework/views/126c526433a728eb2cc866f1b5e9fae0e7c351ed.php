                    ...
                    <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
                        <div class="new-collections-grid1-image cstm_product_img">
                            <a href="<?php echo e(url('/single/')); ?>/<?php echo e(encryptIt($product->id)); ?>" class="product-image">
                                <img src="<?php echo e(IMGPATH); ?>/public/<?php echo e($folder.$fileName); ?>" alt="<?php echo e($product->name); ?>" class="img-responsive"  onerror="this.onerror=null;this.src='<?php echo e(Request::root()); ?>/public/front/images/no_image.jpg'" />
                            </a>
