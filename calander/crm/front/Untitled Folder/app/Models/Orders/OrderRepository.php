...
class OrderRepository extends EloquentRepository
{
     ...
     * Description
     */
    public function getSearchedPaginated($searchData, $items = 10, $orderBy = 'inventory_id', $orderType = 'DESC')
    {
        echo $model = $this->model->forMe()->ordered()
