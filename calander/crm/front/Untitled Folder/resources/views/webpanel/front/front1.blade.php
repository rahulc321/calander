            ...
            <div class="banner-info animated wow zoomIn" data-wow-delay=".5s">
              <!--  <h3>Free Online Shopping</h3>-->
                ...
                <div class="wmuSlider example1">
                    ...
                    <script src="{{Request::root()}}/public/front/js/jquery.wmuSlider.js"></script> 
                    <script>
                        $('.example1').wmuSlider();         
                    </script> 
            </div>
                ...
                <div class="col-md-3 new-collections-grid">
                    ...
                    <div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
                        <div class="new-collections-grid1-image" style="height: 200px !important;">
                            <a href="{{url('/single/')}}/{{encryptIt($product->id)}}" class="product-image"><img src="{{IMGPATH}}/public/{{$folder.$fileName}}" alt=" " class="img-responsive"  onerror="this.onerror=null;this.src='{{Request::root()}}/public/front/images/no_image.jpg'"/></a>
