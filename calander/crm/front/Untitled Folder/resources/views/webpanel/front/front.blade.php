...
<!-- banner -->
    ...
    <div class="new-collections">
        <div class="container">
            ...
            <div class="centr"><h4 class="animated wow zoomIn cat-h" data-wow-delay=".5s">Stylish & Feminine – Smarten up Your Look!</h4></div><br>
            <div class="centr"><p class="animated wow zoomIn" data-wow-delay=".5s">A never goes out of style collection for Women. Let our ladies Italian leather handbags get the weight off your shoulder. Select from our modish range of bags for women, covering casual business bags, satchels, sling bags, compact pouches, sophisticated totes, travel bags, duffle bags, purses and many more!</p></div>
            @endif
            @if($cat_name->category_name == 'Men')
            <div class="centr"><h4 class="animated wow zoomIn cat-h" data-wow-delay=".5s">Bold & Masculine – Take Your Style a Notch Higher!</h4></div><br>
            <div class="centr"><p class="animated wow zoomIn" data-wow-delay=".5s">A very individual and exquisite collection for Men. Just pick from our masculine collection of bags for men, which transition impeccably from business to leisure, including business briefcases, utility bags, stylish messengers, roomy duffle bags and much more. Make your appearance smart and bold with our luxury Italian leather bags and add more class to your style.</p></div>
            @endif
            @if($cat_name->category_name == 'Accessories')
            <div class="centr"><h4 class="animated wow zoomIn cat-h" data-wow-delay=".5s">Rock Your Look the Right Way with Classy Accessories</h4></div><br>
            <div class="centr"><p class="animated wow zoomIn" data-wow-delay=".5s">Crafted from luxurious and 100% genuine leather that only gets superior with age, Moretti Milano accessories are designed to become a longstanding part of your every day. Choose the one as per your need and personality from our wide range of accessories for both men and women. Make accessorizing an utter joy with us!</p></div>
            @endif
           <!-- <p class="est animated wow zoomIn" data-wow-delay=".5s">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia 
                deserunt mollit anim id est laborum.</p>-->
