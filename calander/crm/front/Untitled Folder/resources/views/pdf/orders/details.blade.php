        ...
        <table width="98%" cellspacing="0" cellpadding="4" border="1">
            ...
            @foreach($items as $k => $item)
                <tr>
                    ...
                    <td align="right"> €{{number_format($total/euro()->conversion,2)}}</td>
                </tr>
            @endforeach
            </tbody>
            <tfoot>
            ...
            @if($order->toRefund)
                ...
                <tr>
                    ...
                    <th align="right">
                        {{ currency($refund) }}
                        €{{number_format($refund/euro()->conversion,2)}}
                    </th>
                </tr>
            @endif
            <tr>
                ...
                <th align="right">
                     ...
                     €{{number_format($order->shipping_price/euro()->conversion,2)}}
                </th>
            </tr>
            @if($order->getCreditNoteAmount() > 0)
                <tr>
                    ...
                    <th align="right"> 
                     €{{number_format($order->getCreditNoteAmount()/euro()->conversion,2)}}
                    </th>
                </tr>
            @endif
            <tr>
                ...
                <th align="right">
                    ...
                    €{{number_format(($order->getTotalPrice() - $order->getCreditNoteAmount())/euro()->conversion,2)}}
                </th>
            </tr>
            </tfoot>
        </table>
